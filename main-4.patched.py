...
if App is not None:
    ...
    class Work(Screen):
        ...
        def set_md(self, md: str) -> None:
            # During early screen registration / stylesheet application, widgets may not be mounted yet.
            # In that case, query_one will raise; ignore and let a later refresh/update render.
            try:
    ...
    class BeamScreen(Work):
        ...
        def refresh(self, *args, **kwargs) -> None:
            # Allow Textual to call refresh with args during registration.
            try:
                super().refresh(*args, **kwargs)
            except Exception:
                pass
            # If children aren't mounted yet, defer rendering until later.
